...
if __name__ == '__main__':
    ...
    non_overlapping_videos = [video_data for video_data in all_videos]
    ...
    for video_data in non_overlapping_videos:
        ...
        video_transcript = video_data.video_transcript
        document = str(video_title) + '--' + str(video_transcript)
        send_documents.append(document[0:30000])
